        ...
        <nav className="mt-4 flex flex-col gap-2">
          ...
          <div className="relative group">
            <Link title="Reuniões" className={`px-2 py-2 rounded flex items-center gap-2 ${isActive('/reunioes')}`} to="/reunioes">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                <path d="M3.75 6A2.25 2.25 0 0 1 6 3.75h7.5A2.25 2.25 0 0 1 15.75 6v3.75L20.47 7.1c.91-.52 2.03.14 2.03 1.18v7.44c0 1.04-1.12 1.7-2.03 1.18l-4.72-2.65V18A2.25 2.25 0 0 1 13.5 20.25H6A2.25 2.25 0 0 1 3.75 18V6Z"/>
              </svg>
              {!mini && <span>Reuniões</span>}
            </Link>
            {mini && (
              <span className="pointer-events-none absolute left-full top-1/2 -translate-y-1/2 ml-2 opacity-0 group-hover:opacity-100 transition-opacity bg-slate-900 text-white text-xs rounded px-2 py-1 shadow z-50 whitespace-nowrap dark:bg-slate-700">Reuniões</span>
            )}
          </div>
          {user?.isAdmin && (
            <div className="relative group">
          ...
          <div className="relative group">
            <Link title="Contatos" className={`px-2 py-2 rounded flex items-center gap-2 ${isActive('/contatos')}`} to="/contatos">
              ...
              {!mini && <span>Contatos</span>}
            </Link>
            {mini && (
              <span className="pointer-events-none absolute left-full top-1/2 -translate-y-1/2 ml-2 opacity-0 group-hover:opacity-100 transition-opacity bg-slate-900 text-white text-xs rounded px-2 py-1 shadow z-50 whitespace-nowrap dark:bg-slate-700">Contatos</span>
            )}
          </div>
        </nav>
